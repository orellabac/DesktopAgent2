...
namespace DesktopAgent
{
    public partial class DesktopAgentForm : Form
    {
        ...
        private void SetupServer()
        {
            ...
            var server = new WebSocketServer("ws://0.0.0.0:996");
            //server.Certificate = new System.Security.Cryptography.X509Certificates.X509Certificate2(@"C:\wp\DesktopAgent2.orellabac\localhost.pfx", "test");
            server.Start(c =>
            {
                c.OnOpen = () =>
                {
